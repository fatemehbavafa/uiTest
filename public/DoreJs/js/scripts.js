var cssRelativePath = document.currentScript.src;
cssRelativePath = cssRelativePath.substring(0, cssRelativePath.length - 13);
function loadStyle(e, t) {
    ...
    "undefined" != typeof Storage && localStorage.getItem("theme") && (t = localStorage.getItem("theme")), e(".theme-color[data-theme='" + t + "']").addClass("active"), loadStyle(cssRelativePath + "css/" + t, function() {
        setTimeout(o, 300)
