...
@section('content')
        ...
        <div class="col-12">
            ...
            <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                <ol class="breadcrumb pt-0">
                    <li class="breadcrumb-item"><a href="{{route('user.index')}}">فهرست</a></li>
                    <li class="breadcrumb-item"><a href="{{route('user.create')}}">جدید</a></li>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-body">
                    {{Form::model($user, ['route' => ['user.update', $user->id], 'class'=> 'form-horizontal text-right', 'method' => 'PATCH' ])}}
                    @include('user.form')
                    {{Form::close()}}
                </div>
            </div>
